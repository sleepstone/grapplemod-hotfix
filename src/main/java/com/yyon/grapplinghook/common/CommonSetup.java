...
public class CommonSetup {
    ...
    public static CommonEventHandlers eventHandlers = new CommonEventHandlers();    public static RegistryObject<BlockEntityType<TileEntityGrappleModifier>> grappleModifierTileEntityType = BLOCK_ENTITY_TYPES.register("block_grapple_modifier", () -> BlockEntityType.Builder.of(TileEntityGrappleModifier::new, grappleModifierBlock.get()).build(null));
