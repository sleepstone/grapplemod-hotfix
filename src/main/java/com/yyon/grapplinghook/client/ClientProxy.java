...
//		entity.playSound(new SoundEvent(this.doubleJumpSoundLoc), GrappleConfig.getClientConf().sounds.wallrunjump_sound_volume * 0.7F, 1.0F);
    ...
    public boolean isKeyDown(GrappleKeys key) {
        if (key == GrappleKeys.key_boththrow) {
            return ClientSetup.key_boththrow.isDown();
        } else if (key == GrappleKeys.key_leftthrow) {
            return ClientSetup.key_leftthrow.isDown();
        } else if (key == GrappleKeys.key_rightthrow) {
            return ClientSetup.key_rightthrow.isDown();
        } else if (key == GrappleKeys.key_motoronoff) {
            return ClientSetup.key_motoronoff.isDown();
        } else if (key == GrappleKeys.key_jumpanddetach) {
            return ClientSetup.key_jumpanddetach.isDown();
        } else if (key == GrappleKeys.key_slow) {
            return ClientSetup.key_slow.isDown();
        } else if (key == GrappleKeys.key_climb) {
            return ClientSetup.key_climb.isDown();
        } else if (key == GrappleKeys.key_climbup) {
            return ClientSetup.key_climbup.isDown();
        } else if (key == GrappleKeys.key_climbdown) {
            return ClientSetup.key_climbdown.isDown();
        } else if (key == GrappleKeys.key_enderlaunch) {
            return ClientSetup.key_enderlaunch.isDown();
        } else if (key == GrappleKeys.key_rocket) {
            return ClientSetup.key_rocket.isDown();
        } else if (key == GrappleKeys.key_slide) {
            return ClientSetup.key_slide.isDown();
        }
        return false;
    }
